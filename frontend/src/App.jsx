...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    try {
        ...
        axios.post("https://bajaj-challenge-psi.vercel.app/bfhl",parsedData)
        .then((res)=>{
          setRes(res.data);
        })
  ...
  return (
    <>
      <div className="h-[100vh]">
          <form className=" bg-blue-300 flex flex-col gap-4 w-[80%] h-[80%] px-[5rem] py-[2rem] border-2 shadow-lg rounded-lg m-auto mt-[5rem] " action="">
                <textarea className="w-[100%] border" rows="5" name="api-input" id="api-input" onChange={(e)=>handleChange(e)} placeholder="enterdata"></textarea>
                <button className="bg-green-400 rounded-lg p-2 text-lg font-semibold" onClick={(e)=>handleSubmit(e)}>submit</button>
